			...
			<div className="container">
				...
				<div className="mt-10 flex flex-col gap-20 md:mt-20">
					{portfolioProjects.map((project) => (
						<div
							key={project.title}
							className="afyer:outline-2 relative z-0 overflow-hidden rounded-3xl bg-gray-800 px-8 pt-8 after:pointer-events-none after:absolute after:inset-0 after:z-10 after:rounded-3xl after:outline after:-outline-offset-2 after:outline-white/20 after:content-[''] md:px-10 md:pt-12 lg:px-20 lg:pt-16"
						>
							<div
